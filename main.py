...
import os
from analyse import analyse_video  #Import the analyse function
...
#Function to open file dialogue and select video file
def select_file():
    file_path = filedialog.askopenfilename(filetypes=[("Video Files", "*.mp4;*.avi;*.mov")])
    if file_path:
        analyse_video(file_path)
...
root = tk.Tk()
root.title("Volleyball Video Analyser")
